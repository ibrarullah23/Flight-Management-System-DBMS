...
public class FlightPilotView extends RoundPanel {

    public FlightPilotView(String Operation) {
        initComponents();
        loadtable();
    }
    ...
    private void loadtable(){
        table.removeAll();
        ResultSet rs = DataBaseConnection.getData("select * from flight_pilot where flight_id='"+flightid.getText().trim()+"'");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Flight Pilot's");
        ...
        flightid.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        flightid.setForeground(new java.awt.Color(51, 51, 51));
        flightid.setMargin(new java.awt.Insets(2, 11, 2, 11));
