...
public class AirPlanes extends RoundPanel {

    public AirPlanes(String Operation) {
        initComponents();
        loadAirline();
    }
    ...
    private void loadtable(){
        table.removeAll();
        ResultSet rs = DataBaseConnection.getData("select * from v_airline_plane where airline_name='"+airline.getSelectedItem().toString()+"'");
    ...
    private void initComponents() {
        ...
        roundPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(roundPanel1Layout.createSequentialGroup()
                ...
                .addComponent(airline, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
